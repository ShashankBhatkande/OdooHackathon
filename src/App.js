            ...
            >
              ...
              <div className="p-4">
                ...
                <div className="flex gap-2">
                  <button
                    onClick={() => handleAction("Swap request")}
                    className="flex-1 bg-[#6C3BFF] text-white py-1 px-2 rounded hover:bg-opacity-90 text-sm"
                  >
                    Swap Request
                  </button>
                  <button
                    onClick={() => handleAction("Redeem")}
                    className="flex-1 bg-[#F8AFA6] text-[#2A2A2A] py-1 px-2 rounded hover:bg-opacity-90 text-sm"
                  >
                    Redeem
                  </button>
                </div>
